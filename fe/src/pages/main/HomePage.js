...
const Home = () => {
    ...
    useEffect(() => {
        ...
        /*
            꽃 정보에 따른 추가 작업
        */
        if (flowerInfo.flowerExistence === "empty") {  // 현재 키우고 있는 꽃이 없을 경우
            makeNewSeed();  // 새로운 꽃을 만든다.
        }
        else if(flowerInfo.flowerExistence === "fulfilled") {  // 현재 키우고 있는 꽃이 있고 게이지가 가득 찬 경우
            flowering();
        }
    ...
    useEffect(() => {
        if (elementStatus === 'sun') {
            ...
            sunTimeLine.fromTo(sunBox.current, { y: "-2000" }, {
                y: "-600"
            });
            sunTimeLine.fromTo(sunshine.current, { y: "-1000" }, {
                y: "0",
                duration: 2
            });
            ...
            rainTimeLine.fromTo(rainBox.current, { y: "-1000" }, {
                y: "0",
                duration: 2
            });
        ...
        <div className={styles.HomePage}>
            ...
            {rainAnimation}
                ...
                <div className={styles.FlowerInfo}>
                    ...
                    <GrowProgressBar CurrentGrowthValue={flowerInfo.CurrentGrowthValue} MaxGrowthValue={flowerInfo.MaxGrowthValue}></GrowProgressBar>
                </div>
